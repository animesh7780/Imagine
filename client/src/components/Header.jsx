    ...
    <motion.h1
      ...
      <motion.p
       ...
       initial={{ opacity: 0 }}
        ...
        transition={{ delay: 0.4, duration: 2 }}
       >
        Unleash your creaivity and imagination at one place generate anything you want of your choice without worrying of how do we do it in backend just pay and see the magic happen</motion.p>
